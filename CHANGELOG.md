...
- feat: Allow uploading of multiple gf patterns #1318 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1319>
- feat: Introduce stop multiple scans #1270 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1321>
...
- feat: feat ability to delete multiple scheduled scan #1360 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1382>
- feat: Enhanced Out of Scope Subdomain Checking, Support for regex in out of scope scan parameter #1358 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1380>
- feat: Store and showcase scan related configuration such as imported subdomains, out of scope subdomains, starting point url and excluded paths fixes #1356 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1383>
- Update celery-entrypoint.sh by @SJ029626 in <https://github.com/anggipradana/ReNgGinaNg/pull/1390>
- feat: Prefll the scan parameters during rescan with the scan configuration values that were being used in earlier scan #1381 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1386>
- feat: Added additional templates for PDF reports #1387 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1391>
- Replace CVE-2024-41661 with CVE-2023-50094 by @shelbyc in <https://github.com/anggipradana/ReNgGinaNg/pull/1393>
- hotfix: Workflow autocomment issues by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1396>
- Fix comment workflow on fork PRs by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1400>
...
- @SJ029626 made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1390>
- @shelbyc made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1393>

**Full Changelog**: <https://github.com/anggipradana/ReNgGinaNg/compare/v2.1.3...v2.2.0>
...
- (Security) CVE-2024-43381 Stored Cross-Site Scripting (XSS) via DNS Record Poisoning reported by @touhidshaikh Advisory <https://github.com/anggipradana/ReNgGinaNg/security/advisories/GHSA-96q4-fj2m-jqf7>
...
- chores: Fix docker build on master by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1373>

### New Contributors

- @gitworkflows made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1367>

**Full Changelog**: <https://github.com/anggipradana/ReNgGinaNg/compare/v2.1.2...v2.1.3>
...
- (Security) CVE-2023-50094 Fix Authenticated command injection in WAF detection tool reported by @n-thumann Advisory <https://github.com/anggipradana/ReNgGinaNg/security/advisories/GHSA-fx7f-f735-vgh4>

### Bug Fixes

- Fix issue while initiating periodic and clocked scan #1322 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1328>
- Fix 500 error on "Test Hackerone api Key" by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1332>
- UI Typos and bug Fixes #1333 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1334>
- Fix error during tool update Fixes #1152 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1335>
- Upgrade setuptools to 72.1.0 to resolve installation error by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1338>
- (chores) Fix github pages build by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1339>
- Fix subdomain import for subdomains with suffixes more than 4 chars Fixes #1128 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1340>

**Full Changelog**: <https://github.com/anggipradana/ReNgGinaNg/compare/v2.1.1...v2.1.2>
...
- Update contribution guidelines reference by @emmanuel-ferdman in <https://github.com/anggipradana/ReNgGinaNg/pull/1286>
- fix xss on page title fix #1185 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1296>
- fix context key error #1263 #1209 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1294>
- fix xss on vulnerability description payloads #1262 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1298>
- (bug) fix screenshot csv parser #1299 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1300>
- (Security) Fixes #1202 bug risk of leaking the scan result files by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1301>
...
- Fix Not able to add todo from All Subdomains Section Fixes #1310 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1314>
- Fix #1315 Fix for todo URLs not compatible with slugs by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1316>
- Fixes #1122 But in port service lookup that caused multiple entries of Port with same port number but different service name/description by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1317>

### New Contributors

- @emmanuel-ferdman made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1286>

**Full Changelog**: <https://github.com/anggipradana/ReNgGinaNg/compare/v2.1.0...v2.1.1>
...
- ARM support
- Add LLM Toolkit by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1259>
- use django-env by @fopina in <https://github.com/anggipradana/ReNgGinaNg/pull/1230>
- Add Lark to notifications. by @iuime in <https://github.com/anggipradana/ReNgGinaNg/pull/1137>
- Added restart: always to redis container by @null-ref-0000 in <https://github.com/anggipradana/ReNgGinaNg/pull/1275>
- Dockerfile cleanup: reduce image size 3x by @sa7mon in <https://github.com/anggipradana/ReNgGinaNg/pull/1212>
- Support for ARM-based platforms and remove obsolete composer version by @metehan-arslan in <https://github.com/anggipradana/ReNgGinaNg/pull/1242>
- Fix importing CIDR blocks by @pbehnke in <https://github.com/anggipradana/ReNgGinaNg/pull/1205>
- Added SAN extension to the generated certs by @michschl in <https://github.com/anggipradana/ReNgGinaNg/pull/1282>
- Release/2.1.0 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1147>
- Dockerfile Build Multiple Platforms by @vncloudsco in <https://github.com/anggipradana/ReNgGinaNg/pull/1210>

### New Contributors

- @fopina made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1230>
- @iuime made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1137>
- @null-ref-0000 made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1275>
- @sa7mon made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1212>
- @metehan-arslan made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1242>
- @pbehnke made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1205>
- @michschl made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1282>
- @vncloudsco made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1210>

**Full Changelog**: <https://github.com/anggipradana/ReNgGinaNg/compare/v2.0.6...v2.1.0>
...
- remove duplicate gospider references by @Talanor in <https://github.com/anggipradana/ReNgGinaNg/pull/1245>
- Fix "subdomain" s3 bucket by @Talanor in <https://github.com/anggipradana/ReNgGinaNg/pull/1244>
- Fix Txt File Var Declaration by @specters312 in <https://github.com/anggipradana/ReNgGinaNg/pull/1239>
- Bug Correction: When dumping and loading customscanengines by @TH3xACE in <https://github.com/anggipradana/ReNgGinaNg/pull/1224>
- Fix/infoga removal by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1249>
- Fix #1241 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1251>

### New Contributors

- @Talanor made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1245>
- @specters312 made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1239>
- @TH3xACE made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1224>

**Full Changelog**: <https://github.com/anggipradana/ReNgGinaNg/compare/v2.0.5...v2.0.6>
...
- chore: update version number to 2.0.3 by @AnonymousWP in <https://github.com/anggipradana/ReNgGinaNg/pull/1180>
- Fix various ffuf bugs by @yarysp in <https://github.com/anggipradana/ReNgGinaNg/pull/1199>
- Set and update default YAML config with all latest vars by @yarysp in <https://github.com/anggipradana/ReNgGinaNg/pull/1200>
- Add checks for placeholder in custom tool task by @yarysp in <https://github.com/anggipradana/ReNgGinaNg/pull/1201>
- Whatportis - Replace purge by truncate to prevent port import error by @yarysp in <https://github.com/anggipradana/ReNgGinaNg/pull/1203>
- ops(installation): fix nano not being installed when absent by @AnonymousWP in <https://github.com/anggipradana/ReNgGinaNg/pull/1143>
- Complete dev environment to debug/code easily by @yarysp in <https://github.com/anggipradana/ReNgGinaNg/pull/1196>
- Revert "Complete dev environment to debug/code easily" by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1225>
- Update README.md | Fixed 1 broken link to the regine.wiki by @jostasik in <https://github.com/anggipradana/ReNgGinaNg/pull/1226>
- Fix uninitialised variable cmd in custom_subdomain_tools by @cpandya2909 in <https://github.com/anggipradana/ReNgGinaNg/pull/1207>
- [FIX] security: OS Command Injection vulnerability (x2) #1219 by @0xtejas in <https://github.com/anggipradana/ReNgGinaNg/pull/1227>

### New Contributors :rocket:

- @yarysp made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1199>
- @jostasik made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1226>
- @cpandya2909 made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1207>
- @0xtejas made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1227>

**Full Changelog**: <https://github.com/anggipradana/ReNgGinaNg/compare/v2.0.3...v2.0.4>
...
- CI: update GitHub action versions by @jxdv in <https://github.com/anggipradana/ReNgGinaNg/pull/1136>
- Fixed (subdomain_discovery | ERROR | local variable 'use_amass_config' referenced before assignment) by @Deathpoolxrs in <https://github.com/anggipradana/ReNgGinaNg/pull/1149>
- chore: update LICENSE by @jxdv in <https://github.com/anggipradana/ReNgGinaNg/pull/1153>
- Fix subdomains list empty in Target by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1166>
- Fix top menu text overflow in low resolution by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1167>
- Update auto comment workflow due to deprecation warnings by @ErdemOzgen in <https://github.com/anggipradana/ReNgGinaNg/pull/1126>
- Change Redirect URL after login to prevent 500 error by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1124>
- fix-1030: Add missing slug on target summary link by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1123>

### New Contributors

- @Deathpoolxrs made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1149>
- @ErdemOzgen made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1126>

**Full Changelog**: <https://github.com/anggipradana/ReNgGinaNg/compare/v2.0.2...v2.0.3>
...
- Added tooltip text to dashboard total vulnerabilities tooltip by @luizmlo in <https://github.com/anggipradana/ReNgGinaNg/pull/1029>
- ops(`uninstall.sh`): add missing volumes and echo messages by @AnonymousWP in <https://github.com/anggipradana/ReNgGinaNg/pull/977>
- Fix no results in target subdomain list by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1036>
- Fix Tool Settings Broken Link by @aqhmal in <https://github.com/anggipradana/ReNgGinaNg/pull/1021>
- Fix subdomains list empty in Target by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1053>
- Raise page limit to 500 for popup list by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1051>
- Add directories count on Directories list by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1050>
- ops(docker-compose): upgrade to 2.23.0 by @AnonymousWP in <https://github.com/anggipradana/ReNgGinaNg/pull/1023>
- Fix endpoints list and count by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1041>
- Fix failing visualization when dorks are present by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1045>
- Fix note not saving by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1047>
- Count only not done todos in subdomains list by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1048>
- Fix user agent definition keyword by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1054>
- Upgrade project discovery tool at CT build by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1055>
- Add a check to not load datatables twice by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1039>
- Nmap port scan fails when Naabu return no port by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1067>
- chore(issue-templates): incorrect label name by @AnonymousWP in <https://github.com/anggipradana/ReNgGinaNg/pull/1066>
- Endpoints list popup empty by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1070>
- Add missing domain id value in subscan by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1069>
- Fixes for #1033, #1026, #1027 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1071>
- Temporary fix to prevent celery beat crash by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1072>
- fix: ffuf ANSI code processing preventing task to finish by @ocervell in <https://github.com/anggipradana/ReNgGinaNg/pull/1058>
- Update views.py by @Vijayragha1 in <https://github.com/anggipradana/ReNgGinaNg/pull/1074>
- Fix crash on saving endpoint (FFUF related only) by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1063>
- chore(issue-templates): fix incorrect description by @AnonymousWP in <https://github.com/anggipradana/ReNgGinaNg/pull/1078>
- IOError -> OSError by @jxdv in <https://github.com/anggipradana/ReNgGinaNg/pull/1081>
- Add directories count on Directories list by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1090>
- chore(issue-template): don't allow blank issues by @AnonymousWP in <https://github.com/anggipradana/ReNgGinaNg/pull/1089>
- Fix bad nuclei config name by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1098>
- disallow empty password by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1105>
- fix attribute error on scan history #1103 by @yogeshojha in <https://github.com/anggipradana/ReNgGinaNg/pull/1104>
- issue-633: added already-in-org filter to target dropdown in org form by @SeanOverton in <https://github.com/anggipradana/ReNgGinaNg/pull/1106>
- Update Dockerfile to fix silicon incompatability by @SubGlitch1 in <https://github.com/anggipradana/ReNgGinaNg/pull/1107>
- Add source for nmap scan by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1108>
- Spelling mistake in hackerone.html by @Linuxinet in <https://github.com/anggipradana/ReNgGinaNg/pull/1112>
- fix(version): incorrect number in art by @AnonymousWP in <https://github.com/anggipradana/ReNgGinaNg/pull/1111>
- Fix report generation when `Ignore Informational Vulnerabilities` checked by @psyray in <https://github.com/anggipradana/ReNgGinaNg/pull/1100>
- fix(tool_arsenal): incorrect regex version numbers by @AnonymousWP in <https://github.com/anggipradana/ReNgGinaNg/pull/1086>

### New Contributors

- @luizmlo made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1029> :partying_face:
- @aqhmal made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1021> :partying_face:
- @C0wnuts made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/973> :partying_face:
- @ocervell made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1058> :partying_face:
- @Vijayragha1 made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1074> :partying_face:
- @jxdv made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1081> :partying_face:
- @SeanOverton made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1106> :partying_face:
- @SubGlitch1 made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1107> :partying_face:
- @Linuxinet made their first contribution in <https://github.com/anggipradana/ReNgGinaNg/pull/1112> :partying_face:
...
- Fixed [#482](https://github.com/anggipradana/ReNgGinaNg/issues/482) Endpoints and Vulnerability Datatable were showing results of other targets due to the scan_id parameter
- Fixed [#479](https://github.com/anggipradana/ReNgGinaNg/issues/479) where the scan was failing due to recent httpx release, change was in the JSON output
- Fixed [#476](https://github.com/anggipradana/ReNgGinaNg/issues/476) where users were unable to click on Clocked Scan (Reported only on Firefox)
- Fixed [#442](https://github.com/anggipradana/ReNgGinaNg/issues/442) where an extra slash was added in Directory URLs
- Fixed [#337](https://github.com/anggipradana/ReNgGinaNg/issues/337) where users were unable to link custom wordlist
- Fixed [#436](https://github.com/anggipradana/ReNgGinaNg/issues/436) Checkbox in Notification Settings were not working due to same name attribute, now fixed
- Fixed [#439](https://github.com/anggipradana/ReNgGinaNg/issues/439) Hakrawler crashed if the deep mode was activated due to -plain flag
- Fixed [#437](https://github.com/anggipradana/ReNgGinaNg/issues/437) If Out of Scope subdomains were supplied, the scan was failing due to None value
- Fixed [#424](https://github.com/anggipradana/ReNgGinaNg/issues/424) Multiple Targets couldn't be scanned
...
- Fixed Cross Site Scripting
  - [#460](https://github.com/anggipradana/ReNgGinaNg/issues/460)
  - [#457](https://github.com/anggipradana/ReNgGinaNg/issues/457)
  - [#454](https://github.com/anggipradana/ReNgGinaNg/issues/454)
  - [#453](https://github.com/anggipradana/ReNgGinaNg/issues/453)
  - [#459](https://github.com/anggipradana/ReNgGinaNg/issues/459)
  - [#460](https://github.com/anggipradana/ReNgGinaNg/issues/460)
- Fixed Cross Site Scripting reported on Huntr [#478](https://github.com/anggipradana/ReNgGinaNg/issues/478)
...
- Fixed XSS <https://github.com/anggipradana/ReNgGinaNg/issues/347>
