...
from ReNgGinaNg.views import serve_protected_media

schema_view = get_schema_view(
   openapi.Info(
      title="ReNgGinaNg API",
      default_version='v1',
      description="ReNgGinaNg: An Automated reconnaissance framework.",
...
# ] + static(settings.MEDIA_URL, document_root=settings.RENGGINANG_RESULTS) + \
