...
SECRET_FILE = os.path.join(RENGGINANG_HOME, 'secret')
...
RENGGINANG_CURRENT_VERSION = _version
...
MIDDLEWARE = [
    ...
    'ReNgGinaNg.middleware.UserPreferencesMiddleware',
]
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ReNgGinaNg.context_processors.projects',
                'ReNgGinaNg.context_processors.version_context',
                'ReNgGinaNg.context_processors.user_preferences',
            ],
    },
}]
ROOT_URLCONF = 'ReNgGinaNg.urls'
REST_FRAMEWORK = {
...
WSGI_APPLICATION = 'ReNgGinaNg.wsgi.application'
...
'''
ROLEPERMISSIONS_MODULE = 'ReNgGinaNg.roles'
ROLEPERMISSIONS_REDIRECT_TO_LOGIN = True

'''
Cache settings
'''
RENGGINANG_TASK_IGNORE_CACHE_KWARGS = ['ctx']
