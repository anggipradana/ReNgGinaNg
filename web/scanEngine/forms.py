...
from ReNgGinaNg.validators import validate_short_name
...
class ReportForm(forms.ModelForm):
    ...
    executive_summary_description_id = forms.CharField(
        required=False,
        widget=forms.Textarea(
            attrs={
                "id": "executive_summary_description_id"
            }))
    ...
    report_language = forms.ChoiceField(
        required=False,
        choices=[('en', 'English'), ('id', 'Indonesian (Bahasa Indonesia)')],
        widget=forms.Select(
            attrs={
                "class": "form-control form-control-lg",
                "id": "report_language",
    ...
    document_number = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control form-control-lg",
                "id": "document_number",
                "placeholder": "e.g. DOC-VA-2026-001",
            }))
    ...
    def set_value(self, key):
        ...
        self.initial['report_language'] = key.report_language or 'en'
    ...
    def set_initial(self):
        ...
        self.initial['report_language'] = 'en'
        self.initial['document_number'] = ''
...
**{company_name}** performed both Security Audit and Reconnaissance using automated tool ReNgGinaNg.
...
'''
        self.initial['executive_summary_description_id'] = '''Pada **{scan_date}**, **{target_name}** menugaskan **{company_name}** untuk melakukan audit keamanan pada aplikasi Web mereka.

**{company_name}** melakukan Audit Keamanan dan Rekognisi menggunakan alat otomatis ReNgGinaNg.

## Observasi

Selama pelaksanaan engagement ini, **{company_name}** berhasil menemukan **{subdomain_count}** Subdomain dan **{vulnerability_count}** Kerentanan, termasuk kerentanan informasional yang dapat menimbulkan risiko signifikan terhadap keamanan aplikasi.

Rincian Kerentanan yang Teridentifikasi pada **{target_name}** berdasarkan tingkat keparahan adalah sebagai berikut:

* Kritikal : {critical_count}
* Tinggi : {high_count}
* Sedang : {medium_count}
* Rendah : {low_count}
* Info : {info_count}
* Tidak Diketahui : {unknown_count}

**{company_name}** merekomendasikan agar masalah-masalah ini ditangani secara tepat waktu.
