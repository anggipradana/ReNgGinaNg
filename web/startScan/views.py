...
REPORT_LABELS = {
    'en': {
        ...
        'vulnerabilities_discovered': 'Vulnerabilities Discovered',
        ...
        'reconnaissance_findings': 'Reconnaissance Findings',
        'summary_of_findings': 'Summary of Findings',
        'assessment_timeline': 'Assessment Timeline',
        'confidential': 'CONFIDENTIAL',
        'quick_summary_desc': 'This section contains quick summary of scan performed on',
        ...
        'unknown': 'Unknown',
        'scan_started_on': 'Scan started on',
        'total_time_taken': 'Total time taken',
        'completed_less_1_min': 'Completed in < 1 minutes',
        'completed_in': 'Completed in',
        'aborted_in': 'Aborted in',
        'report_generated_on': 'Report Generated on',
        'summary_of_findings_desc': 'This section provides a summary of the findings.',
        'subdomains_by_http_status': 'Subdomains Breakdown by HTTP Status',
        'vulns_by_severity': 'Vulnerabilities Breakdown by Severity',
        'interesting_subdomains': 'Interesting Subdomains',
        'interesting_subdomains_listed': 'Listed below are the interesting subdomains identified on',
        'no_interesting_subdomains': 'No interesting subdomains were identified on',
        'subdomain': 'Subdomain',
        'page_title': 'Page Title',
        'http_status': 'HTTP Status',
        'summary_of_vulns': 'Summary of Vulnerabilities Identified',
        'no_vulns_identified': 'No vulnerabilities were identified on',
        'vulns_listed': 'Listed below are the vulnerabilities identified on',
        'vulnerability_name': 'Vulnerability Name',
        'instances': 'Instances',
        'severity': 'Severity',
        'discovered_assets': 'Discovered Assets',
        'discovered_assets_desc': 'This section provides a list of assets discovered during the reconnaissance phase.',
        'recon_subdomains_desc': 'During the reconnaissance phase, our subdomain enumeration process revealed:',
        'total_subdomains': 'Total Subdomains',
        'total_subdomains_desc': "This extensive list provides a comprehensive view of the target's online footprint.",
        'active_subdomains': 'Active Subdomains',
        'active_subdomains_desc': 'These subdomains returned an HTTP status 200 (OK), indicating live web assets.',
        'interesting_subdomains_desc': 'High-priority subdomains identified through keyword analysis (e.g., admin, api, test), suggesting a focused investigation.',
        'subdomains_identified_on': 'subdomains identified on',
        'vulnerabilities_count': 'Vulnerabilities Count',
        'ip_assets': 'IP Assets',
        'ip_assets_desc': 'In addition to subdomains, various IP assets associated with the target infrastructure were also identified:',
        'total_ip_addresses': 'Total IP Addresses',
        'total_ip_desc': 'This represents the range of unique IP addresses associated with the discovered subdomains and other network assets.',
        'open_ports': 'Open Ports',
        'geo_location': 'Geo Location',
        'remarks': 'Remarks',
        'recon_findings_desc': 'This section contains list of all the subdomains identified during the reconnaissance phase.',
        'ip_addresses_label': 'IP Addresses',
        'vuln_section_desc': 'This section details the security vulnerabilities identified during our penetration testing engagement. Each finding is documented with its description, potential impact, and recommended remediation steps.',
        'vuln_section_desc2': 'Vulnerabilities are categorized by severity (Critical, High, Medium, Low, Info) to prioritize remediation efforts.',
        'vuln_section_desc3': 'The information presented here is crucial for understanding your current security posture and should guide your remediation strategy to enhance overall security.',
    ...
    'id': {
        ...
        'quick_summary': 'Ringkasan Singkat',
        'table_of_contents': 'Daftar Isi',
        'vulnerabilities_discovered': 'Kerentanan yang Ditemukan',
        'description': 'Deskripsi',
        'impact': 'Dampak',
        'remediation': 'Remediasi',
        'references': 'Referensi',
        'vulnerable_urls': 'URL Rentan',
        'end_of_report': 'AKHIR LAPORAN',
        'reconnaissance_findings': 'Temuan Rekognisi',
        'summary_of_findings': 'Ringkasan Temuan',
        'assessment_timeline': 'Jadwal Penilaian',
        'confidential': 'RAHASIA',
        'quick_summary_desc': 'Bagian ini berisi ringkasan singkat pemindaian yang dilakukan pada',
        'reconnaissance': 'Rekognisi',
        'subdomains': 'Subdomain',
        'endpoints': 'Endpoint',
        'vulnerabilities': 'Kerentanan',
        'vulnerability_summary': 'Ringkasan Kerentanan',
        'critical': 'Kritikal',
        'high': 'Tinggi',
        'medium': 'Sedang',
        'low': 'Rendah',
        ...
        'scan_started_on': 'Pemindaian dimulai pada',
        'total_time_taken': 'Total waktu yang dibutuhkan',
        'completed_less_1_min': 'Selesai dalam < 1 menit',
        'completed_in': 'Selesai dalam',
        'aborted_in': 'Dibatalkan dalam',
        'report_generated_on': 'Laporan dibuat pada',
        'summary_of_findings_desc': 'Bagian ini memberikan ringkasan temuan.',
        'subdomains_by_http_status': 'Rincian Subdomain berdasarkan Status HTTP',
        'vulns_by_severity': 'Rincian Kerentanan berdasarkan Tingkat Keparahan',
        'interesting_subdomains': 'Subdomain Menarik',
        'interesting_subdomains_listed': 'Berikut adalah subdomain menarik yang teridentifikasi pada',
        'no_interesting_subdomains': 'Tidak ada subdomain menarik yang teridentifikasi pada',
        'subdomain': 'Subdomain',
        'page_title': 'Judul Halaman',
        'http_status': 'Status HTTP',
        'summary_of_vulns': 'Ringkasan Kerentanan yang Teridentifikasi',
        'no_vulns_identified': 'Tidak ada kerentanan yang teridentifikasi pada',
        'vulns_listed': 'Berikut adalah kerentanan yang teridentifikasi pada',
        'vulnerability_name': 'Nama Kerentanan',
        'instances': 'Jumlah',
        'severity': 'Tingkat Keparahan',
        'discovered_assets': 'Aset yang Ditemukan',
        'discovered_assets_desc': 'Bagian ini menyediakan daftar aset yang ditemukan selama fase rekognisi.',
        'recon_subdomains_desc': 'Selama fase rekognisi, proses enumerasi subdomain kami mengungkap:',
        'total_subdomains': 'Total Subdomain',
        'total_subdomains_desc': 'Daftar lengkap ini memberikan gambaran komprehensif tentang jejak online target.',
        'active_subdomains': 'Subdomain Aktif',
        'active_subdomains_desc': 'Subdomain ini mengembalikan status HTTP 200 (OK), menunjukkan aset web yang aktif.',
        'interesting_subdomains_desc': 'Subdomain prioritas tinggi yang teridentifikasi melalui analisis kata kunci (misalnya, admin, api, test), menunjukkan investigasi terfokus.',
        'subdomains_identified_on': 'subdomain teridentifikasi pada',
        'vulnerabilities_count': 'Jumlah Kerentanan',
        'ip_assets': 'Aset IP',
        'ip_assets_desc': 'Selain subdomain, berbagai aset IP yang terkait dengan infrastruktur target juga teridentifikasi:',
        'total_ip_addresses': 'Total Alamat IP',
        'total_ip_desc': 'Ini mewakili rentang alamat IP unik yang terkait dengan subdomain yang ditemukan dan aset jaringan lainnya.',
        'open_ports': 'Port Terbuka',
        'geo_location': 'Lokasi Geografis',
        'remarks': 'Keterangan',
        'recon_findings_desc': 'Bagian ini berisi daftar semua subdomain yang teridentifikasi selama fase rekognisi.',
        'ip_addresses_label': 'Alamat IP',
        'vuln_section_desc': 'Bagian ini merinci kerentanan keamanan yang teridentifikasi selama pengujian penetrasi kami. Setiap temuan didokumentasikan dengan deskripsi, dampak potensial, dan langkah remediasi yang direkomendasikan.',
        'vuln_section_desc2': 'Kerentanan dikategorikan berdasarkan tingkat keparahan (Kritikal, Tinggi, Sedang, Rendah, Info) untuk memprioritaskan upaya remediasi.',
        'vuln_section_desc3': 'Informasi yang disajikan di sini sangat penting untuk memahami postur keamanan Anda saat ini dan harus memandu strategi remediasi Anda untuk meningkatkan keamanan secara keseluruhan.',
...
def create_report(request, id):
    ...
    # AI enrichment: fill missing remediation/impact for vulns
    openai_key = get_open_ai_key()
    enricher = None
    if openai_key and show_vuln:
        try:
            enricher = LLMReportEnricher(language=report_language)
            for vuln in vulns.filter(Q(remediation__isnull=True) | Q(remediation=''))[:50]:
                enricher.enrich_vulnerability(vuln)
        except Exception:
            pass
    ...
    if vuln_report_query.exists():
        ...
        data['show_rengginang_banner'] = report.show_rengginang_banner
        ...
        # Use Indonesian version if language is set to 'id' and it exists
        if report_language == 'id' and report.executive_summary_description_id:
            description = report.executive_summary_description_id
        else:
    ...
    # Generate AI remediation summary for executive summary
    if enricher and show_vuln and vulns.filter(severity__gte=2).exists():
        try:
            ai_remediation = enricher.generate_executive_summary_remediation(vulns)
            if ai_remediation:
                data['ai_remediation_summary'] = markdown.markdown(ai_remediation)
        except Exception:
            pass
    ...
    # Report title always in English
    if report_name == 'recon':
        data['report_name'] = 'Reconnaissance Report'
    elif report_name == 'vuln':
        data['report_name'] = 'Vulnerability Report'
    else:
        data['report_name'] = 'Vulnerability Assessment Report'

    # Pass logo and document number
    if vuln_report_settings:
        if vuln_report_settings.company_logo:
            data['company_logo_path'] = vuln_report_settings.company_logo.path
        data['document_number'] = vuln_report_settings.document_number or ''
    else:
